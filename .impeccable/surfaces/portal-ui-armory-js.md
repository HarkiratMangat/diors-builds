---
version: 1
slug: "portal-ui-armory-js"
primary_target: "portal/ui/armory.js"
related_targets: []
---

## Scope and mode

**Armory** — `portal/ui/armory.js`. Mode: **Operate**. Views: Tier board · Repairs · Compare · Bulk & export.

Author and correct weapon loadouts across MP and DMZ — the largest dataset in the portal and the only realm where the list itself is the workspace.
...
**The arriving state:** A build's attachments, image, or category is wrong, or a new build must be added.
...
The Discord preview sits beside the fields that produce it. That adjacency is the realm's whole argument for an inline editor over a modal.
